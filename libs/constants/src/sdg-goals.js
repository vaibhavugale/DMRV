...
exports.SDG_GOALS = void 0;
exports.getAgroforestryRelevantSDGs = getAgroforestryRelevantSDGs;
exports.SDG_GOALS = [
...
function getAgroforestryRelevantSDGs() {
    return exports.SDG_GOALS.filter(g => g.relevantToAgroforestry);
}
//# sourceMappingURL=sdg-goals.js.map